...
// Status
  ...
  if (state.hasWallet != null && !state.hasWallet) {
    ...
    hasWallet = <a id="walletLink" style={{display: 'block'}} href={auroLink} target="_blank" rel="noreferrer">
		<h1 className={styles.walletLink}></h1>
	</a>
	status4();
	noWallet();
  ...
  if (state.hasBeenSetup && !state.accountExists) {
	...
	accountDoesNotExist = <a id="flink" style={{display: 'block'}} href={faucetLink} target="_blank" rel="noreferrer">
		<h1 className={styles.faucetHere}></h1>
	</a>
	status5();
	noAccount();
	hasBeenSetup: false;
  ...
  return (
	...
	<div className={styles.container}>
			<div className={styles.navbar}><h1>bdbdmznzscij</h1> </div>
		<div></div>
		<div></div>
		<div></div>
		<div></div>
	...
	<div><span className={styles.dot}></span></div>
	<div><span className={styles.dot}></span></div>
	<div><span className={styles.dot}></span></div>
	<div><span className={styles.dot}></span></div>
	<div><span className={styles.dot}></span></div>
	...
	<div><span className={styles.dot}></span></div>
	  ...
	  <Head>
        <title>zkApp [thoriqhdd]</title>
        <meta name="description" content="ZkApp By thoriqhdd" />
		...
		<main className={styles.main}>
			<div id="homepage" className={styles.homepage}> 
				...
				<a id="connectBtn" style={{display: 'block'}} onClick={() => {connectBtnclick(); connectWallet();}}>
					...
					<h1 id="status4" style={{display: 'none'}} className={styles.statusTxt2}>Status : Wallet Extension Not Found!</h1>
					<h1 id="status5" style={{display: 'none'}} className={styles.statusTxt2}>Status : Address Not Valid or No Balance!</h1>
					<h1 id="status6" style={{display: 'none'}} className={styles.statusTxt1}>Status : READY FOR TRANSACTION!!!</h1>
					...
					<h1 id="ftxt" style={{display: 'none'}} className={styles.faucetTxt}> <span> Invalid Account or No Balance!! Please check and fund on this link </span> </h1>
			...
			<div id="footer" style={{display: 'block'}} >	
				...
				<a style={{display: 'block'}} href="https://t.me/atmaestro" target="_blank" rel="noopener noreferrer" >
						<span className={styles.teleIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://discordapp.com/users/469786496015269889" target="_blank" rel="noopener noreferrer" >
						<span className={styles.dcIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://github.com/thoriqhdd" target="_blank" rel="noopener noreferrer" >
						<span className={styles.gitIcon}> </span>
					</a>
					
				<a style={{display: 'block'}} href="https://twitter.com/Thoriq_HDD" target="_blank" rel="noopener noreferrer" >
						<span className={styles.twIcon}> </span>
					</a>
